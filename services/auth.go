...
func (s *HickHubAuthService) GenerateAPIToken(userID string) (*models.AccessTokenPair, error) {
	...
	return s.generateAccessTokenPairImpl(userID, "messaging", expiry, expiry)
}
...
func (s *HickHubAuthService) GenerateAccessTokenPair(userID, scope string) (*models.AccessTokenPair, error) {
	...
	return s.generateAccessTokenPairImpl(userID, scope, accessExpiry, refreshExpiry)
}

func (s *HickHubAuthService) generateAccessTokenPairImpl(userID, scope string, accessExpiry, refreshExpiry time.Time) (*models.AccessTokenPair, error) {
